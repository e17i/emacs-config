...
Because of this, we enable elpy in [[init.el]] after loading [[custom.el]].
Nevertheless, provision of a function to reenable it after reloading
[[custom.el]] has been proven to be handy.
