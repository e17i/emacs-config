...
keystrokes. So instead of pressing =C-x z=, you just hold /super/ and
repeatedly press =z=.

#+begin_src emacs-lisp
(defun use-super-as-ctl-x ()
  (keymap-global-set "s-@" #'pop-global-mark)
  (keymap-global-set "C-s-b" #'bs-show)
  (keymap-global-set "C-s-d" #'list-directory)
  (keymap-global-set "C-s-e" #'eval-last-sexp)
  (keymap-global-set "C-s-f" #'find-file)
  (keymap-global-set "C-s-i" #'indent-rigidly)
  (keymap-global-set "C-s-j" #'dired-jump)
  (keymap-global-set "C-s-k" #'kmacro-keymap)
  (keymap-global-set "C-s-k k" #'kmacro-end-or-call-macro)
  (keymap-global-set "C-s-l" #'downcase-region)
  (keymap-global-set "C-s-m" (keymap-global-lookup "C-x C-m"))
  (keymap-global-set "C-s-n" #'set-goal-column)
  (keymap-global-set "C-s-o" #'delete-blank-lines)
  (keymap-global-set "C-s-p" #'mark-page)
  (keymap-global-set "C-s-q" #'read-only-mode)
  (keymap-global-set "C-s-r" #'find-file-read-only)
  (keymap-global-set "C-s-s" #'save-buffer)
  (keymap-global-set "C-s-t" #'transpose-lines)
  (keymap-global-set "C-s-u" #'upcase-region)
  (keymap-global-set "C-s-v" #'navigate-window)
  (keymap-global-set "C-s-w" #'write-file)
  (keymap-global-set "C-s-x" #'exchange-point-and-mark)
  (keymap-global-set "C-s-z" #'repeat)
  (keymap-global-set "C-s-;" #'comment-line)
  (keymap-global-set "C-s-0" #'text-scale-adjust)
  (keymap-global-set "C-s-+" #'text-scale-adjust)
  (keymap-global-set "C-s--" #'text-scale-adjust)
  (keymap-global-set "C-s-=" #'text-scale-adjust)
  (keymap-global-set "M-s-g" #'magit-dispatch)
  (keymap-global-set "C-M-s-0" #'global-text-scale-adjust)
  (keymap-global-set "C-M-s--" #'global-text-scale-adjust)
  (keymap-global-set "C-M-s-+" #'global-text-scale-adjust)
  (keymap-global-set "C-M-s-=" #'global-text-scale-adjust)
  (keymap-global-set "M-s-;" #'repeat-complex-command)
  (keymap-global-set "M-s-:" #'repeat-complex-command)
  (keymap-global-set "s-SPC" #'rectangle-mark-mode)
  (keymap-global-set "s-#" #'server-edit)
  (keymap-global-set "s-$" #'set-selective-display)
  (keymap-global-set "s-'" #'expand-abbrev)
  (keymap-global-set "s-(" #'kmacro-start-macro)
  (keymap-global-set "s-)" #'kmacro-end-macro)
  (keymap-global-set "s-*" #'calc-dispatch)
  (keymap-global-set "s-+" #'balance-windows)
  ;; this is actually #'fit-window-to-buffer - see also #'tear-off-window
                                        ;(keymap-global-set "s--" #'shrink-window-if-larger-than-buffer)
  (keymap-global-set "s-." #'set-fill-prefix)
  ...
  (keymap-global-set "s-4" #'ctl-x-4-prefix)
  (keymap-global-set "s-5" #'ctl-x-5-prefix)
  (keymap-global-set "s-6" #'2C-command)
  (keymap-global-set "s-8 RET" #'insert-char)
  (keymap-global-set "s-8 e" (keymap-global-lookup "C-x 8 e"))
  (keymap-global-set "s-;" #'comment-set-column)
  (keymap-global-set "s-<" #'scroll-left)
  (keymap-global-set "s-=" #'what-cursor-position)
  (keymap-global-set "s->" #'scroll-right)
  (keymap-global-set "s-[" #'backward-page)
                                        ;(keymap-global-set "s-\\" #'activate-transient-input-method)
  (keymap-global-set "s-]" #'forward-page)
  (keymap-global-set "s-^" #'enlarge-window)
  (keymap-global-set "s-&" #'enlarge-window)
  (keymap-global-set "s-`" #'next-error)
  (keymap-global-set "s-a" (keymap-global-lookup "C-x a"))
  (keymap-global-set "s-b" #'switch-to-buffer)
  (keymap-global-set "s-d" #'dired)
  (keymap-global-set "s-g" #'magit-status)
  (keymap-global-set "s-h" #'mark-whole-buffer)
  (keymap-global-set "s-i" #'insert-file)
  (keymap-global-set "s-k" #'kill-buffer)
  (keymap-global-set "s-l" #'count-lines-page)
  (keymap-global-set "s-n" (keymap-global-lookup "C-x n"))
  (keymap-global-set "s-o" #'other-window)
  (keymap-global-set "s-p" (keymap-global-lookup "C-x p"))
  (keymap-global-set "s-q" #'kbd-macro-query)
  (keymap-global-set "s-r" (keymap-global-lookup "C-x r"))
  (keymap-global-set "s-s" #'save-some-buffers)
  (keymap-global-set "s-t" (keymap-global-lookup "C-x t"))
  (keymap-global-set "s-u" #'undo)
  (keymap-global-set "s-v" (keymap-global-lookup "C-x v"))
  (keymap-global-set "s-w" (keymap-global-lookup "C-x w"))
  (keymap-global-set "s-x" (keymap-global-lookup "C-x x"))
  (keymap-global-set "s-z" #'repeat)
  (keymap-global-set "s-{" #'shrink-window-horizontally)
  (keymap-global-set "s-}" #'enlarge-window-horizontally)
  (keymap-global-set "s-<backspace>" #'backward-kill-sentence)
  (keymap-global-set "s-<return>" #'execute-extended-command))
#+end_src
...
#+BEGIN_SRC emacs-lisp
(global-set-key "\221" 'quit-restore-other-window)
