...
step. To ease this, the following functions are introduced. While they follow
the scheme of adding remote control functions for the other window, they
...
Having the repeat commands more within reach also proves very helpful:
