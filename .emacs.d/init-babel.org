...
~scroll-half~ jumps half of the screen size. Each of them enable a recursive
...
mechanism based on the tempo package. This is activated by

#+begin_src emacs-lisp
(require 'org-tempo)
#+end_src

Besides that, =C-c C-,= can be used to insert structure templates,
